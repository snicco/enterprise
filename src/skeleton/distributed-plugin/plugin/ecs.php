...
/*
 * This configuration of EasyCodingStandards is the same we use
 * for all Snicco projects. If you are just getting started
 * this is a good default for new projects.
 *
 * This is totally opinionated, feel free to tweak this to your likings.
 */
return static function (ContainerConfigurator $configurator): void {
    ...
    $parameters->set(Option::SKIP, [__DIR__ . '/tests/_support/_generated']);
