...
return [
     ...
     */
    RoutingOption::HOST => \parse_url(\get_home_url(), \PHP_URL_HOST),
    ...
    RoutingOption::ROUTE_DIRECTORIES => [\dirname(__DIR__) . '/Http/routes'],

    /*
     * This option should be a list of valid (absolute) directories.
     * Feel free to delete it if your project does not need the API routing functionality
     */
    RoutingOption::API_ROUTE_DIRECTORIES => [\dirname(__DIR__) . '/Http/routes/api'],
     ...
     */
    RoutingOption::API_PREFIX => 'VENDOR_SLUG/api',
