...
final class PasswordPolicyAdminAreaTest extends WPTestCase
{
    ...
    public function that_a_password_can_not_be_updated_if_entropy_is_to_small() :void
    {
        ...
        $this->assertSame(['Your password is to insecure or contains references to your personal information. Please generate a secure password.'], $error_messages);
    }
