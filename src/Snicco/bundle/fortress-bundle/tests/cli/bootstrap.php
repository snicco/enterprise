...
if (\is_link($root_folder . '/wp-content/mu-plugins/test-mu-plugin.php')) {
    \codecept_debug('mu-plugin symlink is already present.');
...
$res = \symlink(
    __DIR__ . '/test-mu-plugin/test-mu-plugin.php',
    $root_folder . '/wp-content/mu-plugins/test-mu-plugin.php'
);
