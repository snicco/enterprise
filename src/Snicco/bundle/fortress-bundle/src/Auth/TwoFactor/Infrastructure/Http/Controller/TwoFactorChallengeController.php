...
namespace Snicco\Enterprise\Bundle\Fortress\Auth\TwoFactor\Infrastructure\Http\Controller;
...
final class TwoFactorChallengeController extends Controller
{
	...
	private function processChallenge(Request $request) :Response
	{
		if ( ! $request->accepts('application/json')) {
			throw new HttpException(406, "Requests to {$request->path()} must accept application/json");
		}
