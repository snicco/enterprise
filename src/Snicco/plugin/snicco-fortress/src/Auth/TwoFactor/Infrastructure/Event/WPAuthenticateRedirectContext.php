...
/**
 * This event can be used to adjust the redirect_to and remember_me parameters
 * that are parsed from the server environment before intercepting a successful
 * external authentication attempt through.
 *
 * {@see wp_authenticate()}.
 */
