...
namespace Snicco\Enterprise\Fortress\Session\Domain;
...
final class AuthSession
{
    ...
    /**
     * @internal
     * @psalm-internal Snicco\Enterprise\Fortress\Session\Infrastructure
     */
    public static function fromArrayDataForStorage(string $hashed_token, int $int, array $data): self
    {
        ...
        return new self(
            $hashed_token,
            $int,
            $data['__snicco_last_active'],
            $data['__snicco_last_rotated'],
            $data
        );
    }
