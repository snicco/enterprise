...
namespace Snicco\Enterprise\Fortress\Tests\wpunit\Auth\Authenticator;
...
use Snicco\Enterprise\Fortress\Auth\Authenticator\Domain\Event\FailedMagicLinkAuthentication;
use Snicco\Enterprise\Fortress\Auth\Authenticator\Domain\MagicLinkAuthenticator;
...
final class MagicLinkAuthenticatorTest extends WPTestCase
{
    ...
    public function that_an_invalid_magic_link_cant_authenticate_the_user(): void
    {
        ...
        $this->testable_dispatcher->assertDispatched(
            fn (FailedMagicLinkAuthentication $event): bool => 'Failed authentication with magic link for user [1]'
                                                              === $event->message()
        );
    }
